...
export default function TestimonialsSection() {
  ...
  return (
    <section
      ref={ref}
      className="py-28 px-6 md:px-10 overflow-hidden"
            ...
            >
              {testimonials.map((_, i) => (
                <button
                  ...
                  style={{ width: active === i ? 32 : 12, backgroundColor: active === i ? "#00D4FF" : "rgba(255,255,255,0.18)" }}
